...
import { AdditioServReservationCard, ReservationStatusCard, RoomReservationCard } from "../../../client/components";
import { DeleteEditReservationCard } from "./DeleteEditReservationCard";
import { UserProfileCard } from "./UserProfileCard";
import { Link } from "react-router-dom";

export const ReservationCard = ({reservation, hotelId}) => {
  ...
  return (
    <>
      <section className="border rounded-lg p-6 mb-6 shadow-md bg-blue-100">
        ...
        {/* Info del usuario de la reserva */}
        <div className="container mx-auto p-4">
          <UserProfileCard 
          id={reservation.client.id}
          fullName={reservation.client.fullName}
          email={reservation.client.email}
          profilePictureUrl={reservation.client.profilePictureUrl}
        />
        </div>
